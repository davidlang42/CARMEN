...
namespace UnitTests.SAT
{
    public class BranchAndBoundSolverTests : SolverTests
    {
        ...
        [TestCase(100, 15, 15, 3, TestName = "Speed15")] // 80ms
        [TestCase(100, 20, 20, 3, TestName = "Speed20")] // 240ms
        [TestCase(100, 25, 25, 3, TestName = "Speed25")] // 590ms
        [TestCase(100, 30, 30, 3, TestName = "Speed30")] // 1.3s
        [TestCase(100, 35, 35, 3, TestName = "Speed35")] // 2.9s
        //[TestCase(100, 40, 40, 3, TestName = "Speed40")] // 7.3s
        //[TestCase(100, 45, 45, 3, TestName = "Speed45")] // 17s
        //[TestCase(100, 50, 50, 3, TestName = "Speed50")] // 39s
