...
namespace Carmen.CastingEngine.Selection
{
    ...
    public abstract class SatEngine : SelectionEngine
    {
        ...
        {
            //TODO add a comment about if an applicant meets the requirements for multiple cast groups, it chooses the first cast group in order which has an available spot (and implement that)
        ...
        {
            foreach (var (cg, _) in remaining_groups)//TODO implement order here, can probably use .Keys
            {
