...
namespace Carmen.CastingEngine.Neural
{
    ...
    /// </summary>
    public class SessionLearningVectorEngine : OverallVectorNeuralEngine
    {
        ...
        public SessionLearningVectorEngine(IApplicantEngine applicant_engine, AlternativeCast[] alternative_casts, ShowRoot show_root, Requirement[] requirements, UserConfirmation confirm, Dictionary<string, double> overall_weights)
            : base(applicant_engine, alternative_casts, show_root, requirements, confirm, overall_weights)
        { }
