...
namespace Carmen.CastingEngine.Neural
{
    ...
    /// when it is selected.
    /// </summary>
    public class RoleLearningVectorEngine : OverallVectorNeuralEngine
    {
        public RoleLearningVectorEngine(IApplicantEngine applicant_engine, AlternativeCast[] alternative_casts, ShowRoot show_root, Requirement[] requirements, UserConfirmation confirm, Dictionary<string, double> overall_weights)
